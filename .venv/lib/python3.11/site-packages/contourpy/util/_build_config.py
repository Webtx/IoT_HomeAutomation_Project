...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        python_path=r"/home/seblxx/mqtt_intro/.venv/bin/python3",
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"/tmp/pip-install-eimz7_qz/contourpy_becc186677cc40c9a82a06625c478b47/.mesonpy-imqnzilf/lib/contourpy/util",
        source_dir=r"/tmp/pip-install-eimz7_qz/contourpy_becc186677cc40c9a82a06625c478b47/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True --native-file=/tmp/pip-install-eimz7_qz/contourpy_becc186677cc40c9a82a06625c478b47/.mesonpy-imqnzilf/meson-python-native-file.ini",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
